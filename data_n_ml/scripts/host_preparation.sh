...
sudo -H -u ubuntu bash -c "/home/ubuntu/config.sh --url https://github.com/apinyarr/devops-doct-cicd --token AESNUZRYUKJLPEPGHSDU3YDFFH6MY --runnergroup Default --name linux --labels linux --work _work"
