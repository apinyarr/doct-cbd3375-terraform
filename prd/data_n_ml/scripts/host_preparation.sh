...
sudo -H -u ubuntu bash -c "/home/ubuntu/config.sh --url https://github.com/apinyarr/doct-cbd3375-dataprocessing --token AESNUZSPV6BKG6BRG7KMAHTFHVIDG --runnergroup Default --name linux-prd --labels linux-prd --work _work"
