...
resource "aws_iam_policy" "cyberbullying_lambda_policy" {
  name        = "cyberbullying_lambda_policy"
  description = "cyberbullying_lambda_policy"
...
resource "aws_iam_role" "lambda_cyberbully_role" {
  name = "lambda-cyberbully-role"
...
resource "aws_iam_role_policy_attachment" "terraform_lambda_iam_policy" {
  role = "${aws_iam_role.lambda_cyberbully_role.id}"
  policy_arn = "${aws_iam_policy.cyberbullying_lambda_policy.arn}"
}
...
resource "aws_lambda_permission" "apigw_permission" {
  ...
  function_name = "cyberbullyingpredict" // add a reference to your function name here
...
module "lambda_function_cyberbullying" {
  source = "terraform-aws-modules/lambda/aws"

  function_name = "cyberbullyingpredict"
  ...
  create_role = false
  lambda_role = "${aws_iam_role.lambda_cyberbully_role.arn}"
